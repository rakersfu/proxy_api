...
RAW_URL="${DENOTS_RAW_URL:-https://raw.githubusercontent.com/rakersfu/proxy_api/main/deno.ts}"
# 代理其它网站
#RAW_URL="${DENOTS_RAW_URL:-https://raw.githubusercontent.com/rakersfu/proxy_api/main/deno_google.ts}"
